<%--This jsp contains the user interface for chat. It includes code for presentation, connection, and error.
	- onmessage event deals with receiving binary messages
	- send function deals with sending binary messages
--%>
